...
package System.OS_Constants is
   ...
   EAI_SYSTEM                    : constant := 10107;       --  Check errno for details
   ...
   IPV6_V6ONLY                   : constant := -1;          --  Restricted to IPv6 communications only
   ...
   CLOCK_MONOTONIC               : constant := 3;           --  System monotonic clock
   ...
   SIZEOF_struct_dirent_alloc    : constant := 273;         --  struct dirent allocation
